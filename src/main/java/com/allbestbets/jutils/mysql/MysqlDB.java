...
import com.allbestbets.jutils.ThrowingConsumer;
import com.zaxxer.hikari.HikariDataSource;

import java.io.IOException;
import java.sql.*;

import static com.allbestbets.jutils.ConfigLoader.loadConfig;
...
public class MysqlDB {
    ...
    private HikariDataSource initPool(String fileName, String name) throws IOException {
        try {
            ...
            JdbcConfig jdbcConfig = loadConfig(JdbcConfig.class, fileName);
